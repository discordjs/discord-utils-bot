...
export const EMOJI_ID_GEAR_BLURPLE = '1519987282868699238' as const;
export const EMOJI_ID_NO_TEST = '1263785410853605397' as const;
export const EMOJI_ID_DTYPES = '1263786781669724232' as const;
export const EMOJI_ID_ROUTE = '1519987270080528464' as const;
...
export const API_BASE_ORAMA = 'https://collections.orama.com' as const;
export const MINTLIFY_DISCORD_API = 'https://leaves.mintlify.com/api/search/discord';
export const DISCORD_DOCS_BASE = 'https://docs.discord.com';
export const DISCORD_HELPDESK_BASE = 'https://support.discord.com/api/v2' as const;
export const DISCORD_HELPDESK_DEV_BASE = 'https://support-dev.discord.com/api/v2' as const;
export const DISCORD_HELPDESK_ARTICLES_BASE = 'https://hammerandchisel.zendesk.com/api/v2/' as const;
export const DISCORD_HELPDESK_DEV_ARTICLES_BASE = 'https://discorddevs.zendesk.com/api/v2/' as const;
export const AUTOCOMPLETE_MAX_ITEMS = 25;
export const AUTOCOMPLETE_MAX_NAME_LENGTH = 100;
export const MAX_MESSAGE_LENGTH = 2_000;
export const MAX_CONTENT_LENGTH_COMPONENTS = 4_000;
export const SUGGESTION_PREFIX_ALLOWANCE = 50;
...
export const EXTERNAL_LINK = '↗' as const;
